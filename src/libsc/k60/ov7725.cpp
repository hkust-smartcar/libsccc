...
Ov7725::Ov7725(const Config&)
		: m_config(GetConfiguratorConfig(config)), m_data_array(nullptr),
		  m_clock(nullptr), m_vsync(nullptr), m_dma(nullptr), m_w(0), m_h(0),
		  m_buf_size(0), m_is_shoot(false), m_is_lock_buffer(false),
