...
#define PINOUT_ADC_COUNT 2
#define PINOUT_DMA_CH_COUNT 16
#define PINOUT_DMA_MUX_COUNT 1
#define PINOUT_FTM_COUNT 3
#define PINOUT_FTM_CHANNEL_COUNT 8
#define PINOUT_I2C_COUNT 2
