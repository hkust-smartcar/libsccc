...
//#define LIBSC_LCD_RST PTA10
#define LIBSC_LCD_RST PTA6
#define LIBSC_LCD_DC PTA8
#define LIBSC_LCD_CS PTD7
#define LIBSC_LCD_SDAT PTE4
#define LIBSC_LCD_SCLK PTE5
